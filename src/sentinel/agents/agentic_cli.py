...
1. Execute ONE command at a time based on current state
2. Use full CLI syntax - the command will be executed in a shell
3. Analyze stdout/stderr from previous commands before next step
4. After errors, try 1-2 alternative approaches, then give up
5. "Not found" or "no results" IS a valid answer - call done with the negative result
6. When goal is accomplished OR cannot be completed, set action.type="done"
7. Be concise in results - summarize key outcomes
